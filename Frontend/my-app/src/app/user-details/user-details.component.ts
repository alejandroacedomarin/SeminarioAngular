...
//import { posts } from '../post-details/post-details.component';
@Component({
...
export class UserDetailsComponent {
 ...
 'phone_number':'',
 'gender':'',
 'posts': [ // Aquí definimos un array de posts
 {
...
public updateFormWithUserData(user: User): void {
  ...
  @Output() userH = new EventEmitter<boolean>();
  onSelectPost(user: User): void {
    this.selectedPost = true;
    this.userH.emit(this.selectedPost);
